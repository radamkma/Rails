...
<body>
	<p><a href="admin.html?color=1">Update Colors</a></p>
	<h1>LRT1 NB</h1>
	...
	<table border="1" width="100%" cellpadding="3" cellspacing="3">
		<tr>
			...
			<th align="center">u.Passenger</th>
		</tr>
			...
			%>
				<tr>
					...
					<td><%=recordStations1.getString("curstatus")%></td>
					<td><%=recordStations1.getString("direction")%></td>
					<td><%=recordStations1.getString("transit")%></td>
					<td align="center">
					  <form action="admin.html" method="get">
					  	<input type="text" size="25" name="passengers">
					  	<input type="hidden" name="id" value="<%=recordStations1.getInt("station_id")%>">
		...
		<tr>
			...
			%>
				<tr>
					...
					<td><%=recordStations1a.getString("curstatus")%></td>
					<td><%=recordStations1a.getString("direction")%></td>
					<td><%=recordStations1a.getString("transit")%></td>
					<td align="center">
					  <form action="admin.html" method="get">
					  	<input type="text" size="25" name="passengers">
					  	<input type="hidden" name="id" value="<%=recordStations1a.getInt("station_id")%>">
					  	<input type="submit" value="Update">
					  </form>
					</td>
				</tr>			
		...
		<tr>
			...
			%>
				<tr>
					...
					<td><%=recordStations2.getString("curstatus")%></td>
					<td><%=recordStations2.getString("direction")%></td>
					<td><%=recordStations2.getString("transit")%></td>
					<td align="center">
					  <form action="admin.html" method="get">
					  	<input type="text" size="25" name="passengers">
					  	<input type="hidden" name="id" value="<%=recordStations2.getInt("station_id")%>">
					  	<input type="submit" value="Update">
					  </form>
					</td>
				</tr>			
		...
		<tr>
			...
			%>
				<tr>
					...
					<td><%=recordStations2a.getString("curstatus")%></td>
					<td><%=recordStations2a.getString("direction")%></td>
					<td><%=recordStations2a.getString("transit")%></td>
					<td align="center">
					  <form action="admin.html" method="get">
					  	<input type="text" size="25" name="passengers">
					  	<input type="hidden" name="id" value="<%=recordStations2a.getInt("station_id")%>">
					  	<input type="submit" value="Update">
					  </form>
					</td>
				</tr>			
		...
		<tr>
			...
			%>
				<tr>
					...
					<td><%=recordStations3.getString("curstatus")%></td>
					<td><%=recordStations3.getString("direction")%></td>
					<td><%=recordStations3.getString("transit")%></td>
					<td align="center">
					  <form action="admin.html" method="get">
					  	<input type="text" size="25" name="passengers">
					  	<input type="hidden" name="id" value="<%=recordStations3.getInt("station_id")%>">
					  	<input type="submit" value="Update">
					  </form>
					</td>
				</tr>			
		...
		<tr>
			...
			%>
				<tr>
					...
					<td><%=recordStations3a.getString("curstatus")%></td>
					<td><%=recordStations3a.getString("direction")%></td>
					<td><%=recordStations3a.getString("transit")%></td>
					<td align="center">
					  <form action="admin.html" method="get">
					  	<input type="text" size="25" name="passengers">
					  	<input type="hidden" name="id" value="<%=recordStations3a.getInt("station_id")%>">
					  	<input type="submit" value="Update">
					  </form>
					</td>
				</tr>			
