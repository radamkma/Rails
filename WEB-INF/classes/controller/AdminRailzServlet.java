...
public class AdminRailzServlet extends HttpServlet {
		...
		try {	
			if (connection != null) {
				...
				if (request.getParameter("id")!=null) {
					SQLOperations.updateStation(Integer.parseInt(request.getParameter("passengers")),Integer.parseInt(request.getParameter("id")),connection);
					SQLOperations.updateStationColors(connection);
				}
				...
				getServletContext().getRequestDispatcher("/admindisplay.jsp")
